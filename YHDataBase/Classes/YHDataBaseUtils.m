...
@implementation YHDataBaseUtils
...
+ (NSString *)base64EncodedString:(NSString*)original
{
    ...
    return [YHDataBaseUtils getbase64EncodedStringWithData:data];
}

+ (NSString *)base64DecodedString:(NSString *)base64EncodedString
{
    NSData *data = [YHDataBaseUtils dataWithBase64EncodedString:base64EncodedString];
